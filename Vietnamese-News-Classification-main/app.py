...
with st.container():
    ...
    with col1:
        if os.path.exists("logo_uef.png"):
            st.image("logo_uef.png", width=110)
...
st.markdown(
    ...
    <div style="padding:18px; background:#ffffdd; border-radius:10px;">
        <b>Students:</b><br>
        - Student 1: Võ Hồ Quốc Huy - huyvo22@uef.edu.vn<br>
        - Student 2: Phạm Nhật Trường - truongpn22@uef.edu.vn<br>
        - Student 3: Nguyễn Thịnh - thinhnguyen22@uef.edu.vn<br>
        - Student 4:Ngyễn Thanh Danh - danhn22@uef.edu.vn<br>
    </div>
    """,
    unsafe_allow_html=True
)
